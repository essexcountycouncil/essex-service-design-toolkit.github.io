...
See our [guidance on writing accessible content](/content/designing-content).
...
Write descriptive headings. Include keywords that users are looking for. See our guidance on [optimising content for search](/content/optimise-your-content-for-search).
...
Read our guidance on [formatting links](/content/designing-content).
...
See our guidance on [using images](/content/using-images).
...
See our guidance on [using charts and graphs as images](/content/using-images).
...
Microsoft has guidance on [saving an accessible PDF](https:/helpx.adobe.com/uk/acrobat/using/create-verify-pdf-accessibility.html).
